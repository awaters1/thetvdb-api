...
public class Series   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(added, airsDayOfWeek, airsTime, aliases, banner, firstAired, genre, id, imdbId, lastUpdated, network, networkId, overview, rating, runtime, seriesId, seriesName, siteRating, siteRatingCount, status, zap2itId);
  }
