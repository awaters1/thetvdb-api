...
public class SeriesEpisodesSummary   {
  ...
  private List<String> airedSeasons = new ArrayList<String>();

  @SerializedName("dvdEpisodes")
  private String dvdEpisodes = null;

  @SerializedName("dvdSeasons")
  private List<String> dvdSeasons = new ArrayList<String>();
  ...
  **/
  @ApiModelProperty(example = "null", value = "Number of all aired episodes for this series")
  ...
  **/
   ...
   * @return dvdEpisodes
  **/
  @ApiModelProperty(example = "null", value = "Number of all dvd episodes for this series")
