...
public class UpdatesApi {
    ...
    private com.squareup.okhttp.Call updatedQueryGetCall(String fromTime, String toTime, String acceptLanguage, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/updated/query".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<UpdateData> updatedQueryGetWithHttpInfo(String fromTime, String toTime, String acceptLanguage) throws ApiException {
        com.squareup.okhttp.Call call = updatedQueryGetCall(fromTime, toTime, acceptLanguage, null, null);
    ...
    private com.squareup.okhttp.Call updatedQueryParamsGetCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        

        // create path and map variables
        String localVarPath = "/updated/query/params".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<UpdateDataQueryParams> updatedQueryParamsGetWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = updatedQueryParamsGetCall(null, null);
