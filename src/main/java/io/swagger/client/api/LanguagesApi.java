...
import io.swagger.client.model.LanguageData;
...
public class LanguagesApi {
    ...
    private com.squareup.okhttp.Call languagesGetCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<LanguageData> languagesGetWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = languagesGetCall(null, null);
    ...
    private com.squareup.okhttp.Call languagesIdGetCall(String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/languages/{id}".replaceAll("\\{format\\}","json")
    ...
    public ApiResponse<Language> languagesIdGetWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = languagesIdGetCall(id, null, null);
