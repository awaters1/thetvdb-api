...
public class UsersApi {
    ...
    private com.squareup.okhttp.Call userFavoritesGetCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        

        // create path and map variables
        String localVarPath = "/user/favorites".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<UserFavoritesData> userFavoritesGetWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = userFavoritesGetCall(null, null);
    ...
    private com.squareup.okhttp.Call userFavoritesIdDeleteCall(Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/user/favorites/{id}".replaceAll("\\{format\\}","json")
    ...
    public ApiResponse<UserFavoritesData> userFavoritesIdDeleteWithHttpInfo(Long id) throws ApiException {
        com.squareup.okhttp.Call call = userFavoritesIdDeleteCall(id, null, null);
        Type localVarReturnType = new TypeToken<UserFavoritesData>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    private com.squareup.okhttp.Call userFavoritesIdPutCall(Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public ApiResponse<UserFavoritesData> userFavoritesIdPutWithHttpInfo(Long id) throws ApiException {
        com.squareup.okhttp.Call call = userFavoritesIdPutCall(id, null, null);
        Type localVarReturnType = new TypeToken<UserFavoritesData>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    private com.squareup.okhttp.Call userGetCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public ApiResponse<UserData> userGetWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = userGetCall(null, null);
    ...
    private com.squareup.okhttp.Call userRatingsGetCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        

        // create path and map variables
        String localVarPath = "/user/ratings".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<UserRatingsData> userRatingsGetWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = userRatingsGetCall(null, null);
    ...
    private com.squareup.okhttp.Call userRatingsItemTypeItemIdDeleteCall(String itemType, Long itemId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/user/ratings/{itemType}/{itemId}".replaceAll("\\{format\\}","json")
    ...
    public ApiResponse<UserRatingsDataNoLinksEmptyArray> userRatingsItemTypeItemIdDeleteWithHttpInfo(String itemType, Long itemId) throws ApiException {
        com.squareup.okhttp.Call call = userRatingsItemTypeItemIdDeleteCall(itemType, itemId, null, null);
    ...
    private com.squareup.okhttp.Call userRatingsItemTypeItemIdItemRatingPutCall(String itemType, Long itemId, Long itemRating, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/user/ratings/{itemType}/{itemId}/{itemRating}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "itemType" + "\\}", apiClient.escapeString(itemType.toString()))
        .replaceAll("\\{" + "itemId" + "\\}", apiClient.escapeString(itemId.toString()))
    ...
    public ApiResponse<UserRatingsDataNoLinks> userRatingsItemTypeItemIdItemRatingPutWithHttpInfo(String itemType, Long itemId, Long itemRating) throws ApiException {
        com.squareup.okhttp.Call call = userRatingsItemTypeItemIdItemRatingPutCall(itemType, itemId, itemRating, null, null);
    ...
    private com.squareup.okhttp.Call userRatingsQueryGetCall(String itemType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        

        // create path and map variables
        String localVarPath = "/user/ratings/query".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<UserRatingsData> userRatingsQueryGetWithHttpInfo(String itemType) throws ApiException {
        com.squareup.okhttp.Call call = userRatingsQueryGetCall(itemType, null, null);
        Type localVarReturnType = new TypeToken<UserRatingsData>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    private com.squareup.okhttp.Call userRatingsQueryParamsGetCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        

        // create path and map variables
        String localVarPath = "/user/ratings/query/params".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<UserRatingsQueryParams> userRatingsQueryParamsGetWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = userRatingsQueryParamsGetCall(null, null);
