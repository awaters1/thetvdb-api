...
import io.swagger.client.model.EpisodeRecordData;
...
public class EpisodesApi {
    ...
    private com.squareup.okhttp.Call episodesIdGetCall(Long id, String acceptLanguage, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/episodes/{id}".replaceAll("\\{format\\}","json")
    ...
    public ApiResponse<EpisodeRecordData> episodesIdGetWithHttpInfo(Long id, String acceptLanguage) throws ApiException {
        com.squareup.okhttp.Call call = episodesIdGetCall(id, acceptLanguage, null, null);
